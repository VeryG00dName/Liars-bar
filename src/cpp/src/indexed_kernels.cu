...
void grouped_ffn_gemm_forward(
    ...
    // Simple wrapper around CUTLASS grouped MoE kernel
    // All fallback/guard logic has been removed - CUTLASS or crash (fail-fast)
    ...
    // Delegate directly to CUTLASS grouped MoE implementation
